                      ...
                      <ul class="rd-navbar-nav">
                        ...
                        <? if (!Yii::$app->user->isGuest) { ?>
                          <li class="rd-nav-item">
                            <a class="rd-nav-link user" href="/task/user">Мои задачи</a>
                          </li>  
                       <? } ?>

                        <li class="rd-nav-item"><a class="rd-nav-link costs" href="/labor-costs">Создание трудозатрат</a></li>

                        <li class="rd-nav-item"><a class="rd-nav-link task" href="/task/user">Создание задачи</a>  </li>
                        <li class="rd-nav-item">
                        <? if (!Yii::$app->user->isGuest) { ?>
                                <a><?= Html::a(
                                    'Выход',
